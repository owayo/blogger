...
Logroid.related_posts = Logroid.related_posts || (function(logroid) {
  ...
  function getFeed(label) {
    ...
    $.getJSON("https://query.yahooapis.com/v1/public/yql?q=select%20updated%2Ctitle%2Clink%20from%20rss%20where%20url%20%3D%20'https%3A%2F%2Flogroid.blogspot.com%2Ffeeds%2Fposts%2Fdefault%2F-%2F" + label + "%3Falt%3Drss'&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys", function(res) {
      console.dir(res);
    });
    $.ajax({
